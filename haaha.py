...
# Auto install required modules SEBELUM import apapun yang membutuhkannya
...
# Install modules LANGSUNG sebelum import PIL
if not install_required_modules():
    print("FATAL: Tidak dapat menginstall modules yang diperlukan!")
    sys.exit(1)

# NOW import PIL setelah modules terinstall
